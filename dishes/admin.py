"""
Admin configuration for Category, Dish, DishImage, and DishPortion models.
(inlines, image previews, and list display customizations)
"""
...
class DishAdmin(admin.ModelAdmin):
    list_display = (
        'image_preview', 'name', 'category', 'available', 'is_special',
        'prep_time', 'calories', 'created', 'updated'
    )
    list_filter = (
        'available', 'created', 'updated', 'category',
        'dietary_info', 'is_special'
    )
