"""
Views for managing Dishes and Categories.
(listing, detail, add, edit, and delete operations)
"""
...
def add_dish(request):
    ...
    portion_formset = DishPortionFormSet(
        request.POST or None,
        instance=form.instance
    )
    image_formset = DishImageFormSet(
        request.POST or None,
    ...
    return render(request, "dishes/add_edit_dish.html", context)
